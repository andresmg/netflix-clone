const requests = {
    fetchTrending: `/trending/all/day?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US`,
    fetchNetflixOriginals: `/discover/tv?api_key=${process.env.REACT_APP_TMDB_API_KEY}&with_networks=213&append_to_response=videos,release_dates`,
    ...
    fetchGenres: `/genre/movie/list?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US`
